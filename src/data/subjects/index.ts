...
const chapters: Record<string, ChapterContent> = {
  "函数与极限": ch01 as ChapterContent,
  "导数与微分": ch02 as ChapterContent,
  "中值定理与导数应用": ch03 as ChapterContent,
  "不定积分": ch04 as ChapterContent,
  "定积分": ch05 as ChapterContent,
  "微分方程": ch06 as ChapterContent,
};
