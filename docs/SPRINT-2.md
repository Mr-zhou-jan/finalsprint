...
> 版本: v1.0 | 日期: 2026-06-22 | 前提: Sprint 1 + 产品收口补丁已完成 + 闸门全过

## ⛔ Sprint 2 禁止项（写死）

**Sprint 2 只做一件事：让用户在"摸底 → 看风险 → 拿路线 → 做今天任务"链路跑通。**
...
| ❌ 错题本闭环 | S3 |
| ❌ 模拟考完整闭环 | S4 |
| ❌ 考点冲刺卡 teach-me 学习页 | S3 |
| ❌ 多材料并行重解析的复杂编排 | S3 |
| ❌ 视频字幕精细时间轴回放 | S3 |
| ❌ 用户手动编辑 ExamPoint 关系图 | 永不 |
| ❌ 多 AI Provider 调度优化 | V2 |
| ❌ 学习社区/排名/战报社交化 | 永不 |
| ❌ 单独修改优先级/预计提分的辅助接口 | 领域接口收敛 |
| ❌ 花哨图表/动画 | 功能优先 |
